...
module.exports = function (app) {
    app.post('/api/register', async (req, res) => {
        ...
        try {
            ...
            await getDb().collection('users').insertOne({ phone, password: hashed, name, grade: '', area: '', school: '', role: 'teacher', is_admin: false, plan: 'free', plan_expires: null, created_at: new Date() });
